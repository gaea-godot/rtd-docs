...
!!! note
    Before this tutorial, make sure Gaea is enabled in the project settings.
...
A core part of Gaea are its **modifiers**. Used to make changes to your generation, they can be really useful to improve the look and/or functionality of the default generators. You can read more about them in [Modifiers](../the-basics/modifiers.md)
