...
Noise 2D uses [FastNoiseLite](https://docs.godotengine.org/en/stable/classes/class_fastnoiselite.html)'s `get_noise_2d` method, whereas Noise 3D users the `get_noise_3d` method.
